      ...
      <div className="whitebox">
        ...
        <div className="mypageContentsArea">
          ...
          <div className="userArea">
            ...
            <div className="userInfo">
              <div className="item">
                ...
                <div className="item-value">{userInfo.username}</div>
              </div>
              <div className="item">
                <div className="item-label">이메일</div>
                <div className="item-value">{userInfo.userid}</div>
              </div>
            </div>
          </div>
          ...
          {babyInfo.length > 0 ? (
            ...
            <div className="w-full h-[34.75rem]  flex justify-center items-center  ">
