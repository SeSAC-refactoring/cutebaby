        ...
        <div className={layout.container}>
            ...
            <div className={`${styles.contentsArea}`}>
                ...
                <div className={styles.userArea}>
                    <div
                        className={`${styles.userGreeting} ${typography.text4xlMd}`}
                    >
                        <div>
                            <strong
                                className={`${styles.user} ${typography.text4xlBd}`}
                            >
                                {username}
                            </strong>
                            님,
                        ...
                        <div
                            className={`${styles.pageGuide} ${typography.textLgRg}`}
                        >
                            우리아이{' '}
                            <span className={typography.textLgMd}>
                                예방접종을 관리
                            </span>
                            하고,{' '}
                            <span className={typography.textLgMd}>
                        ...
                        <div className={styles.diaryChartWrap}>
                            {growData.length > 0 ? (
                                ...
                                <div className={styles.no_diary_chart}>
                                    ...
                                    <div
                                        className={styles.no_diary_chart_bottom}
                                    >
                ...
                <div className={AI.chatbotArea}>
                    <div className={AI.chatbotWrap}>
                        <div className={AI.chatHeaderWrap}>
                            ...
                            <div
                                className={`${AI.chat_date} ${typography.textBsRg}`}
                            >
                        ...
                        <AiChatComponent username={username} />
                    </div>
                </div>
            </div>
        </div>
