    ...
    const diseasesResult =
        selectedDis !== undefined
            ? filteredDiseases.filter(
                  (diseaseIndex) => diseaseIndex === selectedDis
              )
            : filteredDiseases;
                ...
                >
                    <thead className=" bg-blue-3 text-blue-8 w-full sticky top-0">
                        <tr className="w-full">
                            ...
                            <th className="text-left w-[20]%] p-2">
                                백신 종류
                            </th>
                            ...
                            <th className="rounded-r-[0.5rem] w-[10%] ">
                                관리
                            </th>
                        </tr>
                        {/* 테이블 사이 넓히는 용도 */}
                            ...
                            >(
                                (acc, diseaseIndex, diseaseIdx) => {
                                    ...
                                    const filteredVaccines =
                                        matchedVaccines.filter((vaccine) => {
                                            const vacid = vaccine.vaccinationid;
                                            const completedDoses =
                                                matchedVaccineList.filter(
                                                    (v) =>
                                                        v?.vaccinationid ===
                                                        vacid
                                                ).length;
                                            ...
                                            const isOptionalVaccine =
                                                vaccine.doses === '-';
                                            const doseCount =
                                                typeof vaccine.doses ===
                                                'number'
                                                    ? vaccine.doses
                                                    : 0; // "-"일 경우 0 처리
                                    ...
                                    const rowColor = isEvenDisease
                                        ? 'bg-blue-1'
                                        : 'bg-white';

                                    filteredVaccines.forEach(
                                        (vaccine, index) => {
                                            // 감염병의 모든 백신 ID를 배열로 가져옴
                                            const vaccineIds = Array.isArray(
                                                disease.vaccinationid
                                            )
                                                ...
                                                >
                                                    ...
                                                    {index === 0 ? (
                                                        <td
                                                            ...
                                                            data-vaccine={vaccineIds.join(
                                                                ' '
                                                            )} // 여러 개의 백신 ID를 공백으로 구분하여 저장
