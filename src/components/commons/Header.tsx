        ...
        {!Logined ? (
          <nav>
            <Link to="/">
              <img
                ...
                alt="홈"
              />
              <p className={location.pathname === "/" ? "active" : ""}>홈</p>
            </Link>
            ...
            <Link to="/SelectLogin">
              ...
              />
              <p
                className={location.pathname === "/SelectLogin" ? "active" : ""}
              >
                로그인
              </p>
            </Link>
          ...
          <nav>
            ...
            <Link to="/Vaccination">
              ...
              />
              <p
                className={location.pathname === "/Vaccination" ? "active" : ""}
              >
                예방접종
              </p>
            </Link>
            ...
            <Link to="/GrowthDiary">
              ...
              />
              <p
                className={location.pathname === "/GrowthDiary" ? "active" : ""}
              >
                성장일지
              </p>
            </Link>
            ...
            <Link to="/Mypage">
              <img
                ...
                alt="마이페이지"
              />
              <p className={location.pathname === "/Mypage" ? "active" : ""}>
                마이페이지
              </p>
            </Link>
