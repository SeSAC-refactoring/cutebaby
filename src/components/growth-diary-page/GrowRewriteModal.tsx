...
export const GrowRewriteModal:React.FC<GrowRewriteModalProps>  = ({onClose , growData , growId}:any ) => {
  ...
  const rewrite = async()=>{
    setrewriteData((prev) => ({ ...prev, babyid: growData[0].babyid, id:growId,inputData: growData[0].inputData}));
    ...
    <div className={styles.modal_background}>
      <div className={styles.modal_container}>
        ...
        <div className={styles.modal_button_container}>
          ...
          <button
           onClick={rewrite}className={`${styles.modal_btn} ${styles.modal_done_button}` }
          >
            완료
          </button>
        </div>
